	...
	<table>
		...
		<tbody>
			<tr>
				<th>번호</th>
				<td>
					<span class="badge badge-primary bold">${recruitment.id}</span>
				</td>
			</tr>
			<tr>
				<th>날짜</th>
			...
			<tbody>
				...
				<c:forEach var="i" begin="1"
					...
					<tr>
						...
						<td>
							<div class="form-control-box">
								<input id="ApplymentFile" type="file"
					...
					function() {
						...
						if (files.length != 0) {
							...
							setTimeout(
									function() {
										var duration = Math
												.floor(video.duration);
										var oneMinute = Math
												.floor(video.duration > 60 ? video.duration / 60
														: 0);
