...
public class MailService {
	...
	public ResultData sendVerifyEmail(String email, String siteName, String verifyCode, String regDate) {
		...
		sb.append("<table><tr><td>인증번호 : </td><td style=\"font-weight: bold; font-size: 25px\"> "+ verifyCode + "</td></tr></table>");
		sb.append("<table><tr><td>발급시간 : </td><td style=\"font-weight: bold; font-size: 25px\"> " + regDate + "</td></tr></table></td>");
	...
	public ResultData sendTempPw(String email, String siteName, String msg) {
		
		String title = "[" + siteName + "] 비밀번호 안내";
		...
		sb.append("<tr><td align=\"center\" style=\"font-size: 0; line-height: 0; height: 0;\" height=\"0\"><img src=\"https://bangsuyeong.shop/resource/img/mobile_header.png\" width=\"176px\" height=\"16px\" alt=\"Brand name\" /></td></tr>");
		sb.append("<tr><td align=\"center\" style=\"font-size: 0; line-height: 0; height: 0;\" height=\"0\"><img src=\"https://bangsuyeong.shop/resource/img/logoForLogin.png\" alt=\"Logo image\" width=\"200px\" height=\"200px\" /></td></tr>");
		sb.append("<tr><td align=\"center\" style=\"color: green; font-family: Arial, sans-serif\"> 안녕하세요 AUDITION TREE 입니다. <br /> 발급된 임시 비밀번호 입니다. </td></tr>");
		sb.append("<tr><td align=\"center\"><table align=\"center\" border=\"0\" cellpadding=\"30px\" cellspacing=\"20px\" width=\"500px\"><tr>");
		sb.append("<td align=\"center\" bgcolor=\"#66CC66\" style=\"border-radius: 10px; color: white; font-family: Arial, sans-serif; line-height: 40px\">");
		sb.append("<table><tr><td>임시 비밀번호 : </td><td style=\"font-weight: bold; font-size: 25px\"> "+ msg + "</td></tr></table>");
		sb.append("</tr></table></td></tr>");
		sb.append("</table>");
		sb.append("</body>");
		sb.append("</html>");
	...
	public ResultData sendloginId(String email, String siteName, String msg) {
		
		String title = "[" + siteName + "] 회원 아이디 안내";
		...
		sb.append("<tr><td align=\"center\" style=\"font-size: 0; line-height: 0; height: 0;\" height=\"0\"><img src=\"https://bangsuyeong.shop/resource/img/mobile_header.png\" width=\"176px\" height=\"16px\" alt=\"Brand name\" /></td></tr>");
		sb.append("<tr><td align=\"center\" style=\"font-size: 0; line-height: 0; height: 0;\" height=\"0\"><img src=\"https://bangsuyeong.shop/resource/img/logoForLogin.png\" alt=\"Logo image\" width=\"200px\" height=\"200px\" /></td></tr>");
		sb.append("<tr><td align=\"center\" style=\"color: green; font-family: Arial, sans-serif\"> 안녕하세요 AUDITION TREE 입니다. <br /> 회원님의 아이디는 다음과 같습니다. </td></tr>");
		sb.append("<tr><td align=\"center\"><table align=\"center\" border=\"0\" cellpadding=\"30px\" cellspacing=\"20px\" width=\"500px\"><tr>");
		sb.append("<td align=\"center\" bgcolor=\"#66CC66\" style=\"border-radius: 10px; color: white; font-family: Arial, sans-serif; line-height: 40px\">");
		sb.append("<table><tr><td>회원 아이디 : </td><td style=\"font-weight: bold; font-size: 25px\"> "+ msg + "</td></tr></table>");
		sb.append("</tr></table></td></tr>");
		sb.append("</table>");
		sb.append("</body>");
		sb.append("</html>");
